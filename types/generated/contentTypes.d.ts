...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    AboutCards: Schema.Attribute.Component<'cards.milestone-card', true>;
    ci_info: Schema.Attribute.Text;
    ci_title: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ExpertiseCards: Schema.Attribute.Component<'cards.expertise-card', true>;
    ExpertiseMedia: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    history_subtitle: Schema.Attribute.String;
    history_title: Schema.Attribute.String;
    HistoryList: Schema.Attribute.Component<'cards.histoy-card', true>;
    ...
    > &
      Schema.Attribute.Private;
    PresentDayImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    PresentDayInfo: Schema.Attribute.Text;
    PresentDayTitle: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    Adamallys_Group: Schema.Attribute.Component<'navigation.links', true>;
    AdamallysGroup2: Schema.Attribute.Component<
      'footer.adamallys-group-2',
      false
    >;
    AdamallysLLC: Schema.Attribute.Component<'footer.adamallys-llc', false>;
    AdamallysMarineShipChandlingServices: Schema.Attribute.Component<
      'footer.adamallys-marine-ship-chandling-services',
      false
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    Button: Schema.Attribute.Component<
      'navigation.request-a-qoute-button',
      false
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    > &
      Schema.Attribute.Private;
    Logo: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    NavLinks: Schema.Attribute.Component<'navigation.links', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    BrandContent: Schema.Attribute.Text;
    CertificationsMemberships: Schema.Attribute.Component<
      'navigation.icon-link',
      true
    >;
    ContentCard: Schema.Attribute.Component<'cards.content-card', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMilestoneSectionMilestoneSection
  extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Milestones: Schema.Attribute.Component<'cards.milestone-card', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
